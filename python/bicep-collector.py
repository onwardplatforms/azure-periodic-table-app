...
def main():
    parser = argparse.ArgumentParser(description="Scrape and save Bicep or ARM templates")
    parser.add_argument('--storage', default='../public/code', help='Storage location for the files')
    parser.add_argument('--type', choices=['bicep', 'arm'], default='bicep', help='Template type to scrape')
