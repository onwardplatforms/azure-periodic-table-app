    ...
    items: [
      {
        ...
        slug: 'acg-',
        description: 'Amazon CodeGuru is a machine learning service for automated code reviews and application performance recommendations. It helps you find the most expensive lines of code that hurt application performance and keep you up all night troubleshooting.',
        length: '1-90',
        category: Categories.AIANDML,
        learnUrl: 'https://aws.amazon.com/codeguru/',
        terraformUrl: 'https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/codeguru_profiler_profiling_group',
        restrictions: 'Alphanumerics, hyphens, and underscores. Must be unique within your AWS account. 3-63 characters.',
        icon: '/aws/icons',
        terraformCode: ``,
      },
      {
        ...
        length: '1-90',
        category: Categories.AIANDML,
        learnUrl: 'https://aws.amazon.com/comprehend/',
        terraformUrl: 'https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/comprehend_document_classifier',
        restrictions: 'Alphanumerics, hyphens, and underscores. Must be unique within your AWS account. 3-63 characters.',
        icon: '/aws/icons',
        terraformCode: ``,
      },
      {
        ...
        slug: 'afc-',
        description: 'Amazon Forecast is a fully managed service that uses machine learning to deliver highly accurate forecasts. Forecast is applicable in a wide variety of use cases, including energy demand forecasting, estimating product demand, workforce planning, and computing cloud infrastructure usage.',
        length: '1-90',
        category: Categories.AIANDML,
        learnUrl: 'https://aws.amazon.com/forecast/',
        terraformUrl: 'https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/forecast_dataset_group',
        restrictions: 'Alphanumerics, hyphens, and underscores. Must be unique within your AWS account. 3-63 characters.',
        icon: '/aws/icons',
        terraformCode: ``,
      },
      {
        ...
        length: '1-90',
        category: Categories.AIANDML,
        learnUrl: 'https://aws.amazon.com/lex/',
        terraformUrl: 'https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/lex_bot_alias',
        restrictions: 'Alphanumerics, hyphens, and underscores. Must be unique within your AWS account. 3-63 characters.',
        icon: '/aws/icons',
        terraformCode: ``,
      },
      {
        ...
        length: '1-90',
        category: Categories.AIANDML,
        learnUrl: 'https://aws.amazon.com/polly/',
        terraformUrl: 'https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/polly_lexicon',
        restrictions: 'Alphanumerics, hyphens, and underscores. Must be unique within your AWS account. 3-63 characters.',
        icon: '/aws/icons',
        terraformCode: ``,
      },
      {
        ...
        length: '1-90',
        category: Categories.AIANDML,
        learnUrl: 'https://aws.amazon.com/rekognition/',
        terraformUrl: 'https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/rekognition_collection',
        restrictions: 'Alphanumerics, hyphens, and underscores. Must be unique within your AWS account. 3-63 characters.',
        icon: '/aws/icons',
        terraformCode: ``,
      },
