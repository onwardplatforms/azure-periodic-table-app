...
import { Categories_Azure } from './constants';
import { Categories_AWS } from './constants';
...
export type Item_AWS = {
  id: string;
  name: string;
  slug: string;
  description: string;
  length: string;
  category: Categories_AWS;
  learnUrl: string;
  terraformUrl: string;
  restrictions: string;
  resource: string;
...
export type ColumnType_AWS = {
  items: Item_AWS[];
};

export const columns_aws: ColumnType_AWS[] = [
  {
    items: [
      {
        id: 'athena',
        ...
        length: '1-80',
        category: Categories_AWS.ANALYTICS,
        learnUrl: 'https://aws.amazon.com/athena/',
        terraformUrl: 'https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/athena_database',
...
export type Item_Azure = {
  id: string;
  name: string;
  slug: string;
  description: string;
  length: string;
  category: Categories_Azure;
  learnUrl: string;
  terraformUrl: string;
  restrictions: string;
  resource: string;
...
export type ColumnType_Azure = {
  items: Item_Azure[];
};

export const columns_azure: ColumnType_Azure[] = [
  {
    items: [
      {
        id: 'management-group',
        ...
        length: '1-90',
        category: Categories_Azure.GENERAL,
    ...
    items: [
      {
        ...
        description: 'Azure Application Gateway is a web traffic load balancer that enables management of traffic to web applications. It provides routing services and can make routing decisions based on additional attributes of an HTTP request.',
        length: '1-80',
        category: Categories_Azure.NETWORKING,
    ...
    items: [
      {
        ...
        length: '2-60',
        category: Categories_Azure.COMPUTEANDWEB,
    ...
    items: [
      {
        ...
        length: '1-63',
        category: Categories_Azure.CONTAINERS,
    ...
    items: [
      {
        ...
        length: '3-44',
        category: Categories_Azure.DATABASES,
      ...
      },
      {
        ...
        length: '3-24',
        category: Categories_Azure.STORAGE,
    ...
    items: [
      {
        ...
        length: '1-260',
        category: Categories_Azure.AIANDML,
    ...
    items: [
      {
        ...
        length: '3-63',
        category: Categories_Azure.ANALYTICSANDIOT,
    ...
    items: [
      {
        ...
        length: '1-64',
        category: Categories_Azure.VIRTUALDESKTOP,
      ...
      },
      {
        ...
        length: '5-50',
        category: Categories_Azure.DEVTOOLS,
    ...
    items: [
      {
        ...
        length: '1-50',
        category: Categories_Azure.INTEGRATION,
      ...
      },
      {
        ...
        length: '2-62',
        category: Categories_Azure.MIGRATION,
    ...
    items: [
      {
        ...
        length: '6-50',
        category: Categories_Azure.MANAGEMENT,
